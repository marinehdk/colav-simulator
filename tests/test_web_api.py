...
def test_header_uses_requested_session_labels() -> None:  # noqa: PLR0915
    with TestClient(app) as client:
        ...
        assert 'id="plannerSurfaceDetach"' in page.text
        ...
        assert "setPlannerSurfaceAttached(true)" in script.text
        assert "updateAttachedPlannerSurfacePosition(data.os)" in script.text
        assert all(
